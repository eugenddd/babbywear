<template>
  ...
  <div>
    ...
    <div style="display:flex; gap:.3rem; align-items:center !important; padding:1rem 5.5%; border-bottom: 1px solid grey; height:9vh;
 ">
      <div>
      ...
      <div>
        <h6 style="color: white !important; font-weight: 600;">Admin</h6>
    ...
    <div style="margin-top:1rem;">
      ...
      <div v-for="item in links" :key="item.name"
        style="display:grid; grid-gap:.5em; background: black; color: white !important;  padding:.1rem 6.5%;">

        <nuxt-link :to="item.path">

          <!-- <v-icon v-if="item.icon">{{ item.icon }}</v-icon> -->
          <!-- class="v-icon notranslate mdi mdi-tag theme--light" -->
          <!-- <i v-if="item.name === 'Products'" /> -->
    ...
    return {
      ...
      links: [
        ...
        },
        {
          name: "Products",
          path: "/admin/products",
          svg: "../assets/imgs/product-icon-admin.svg",
          subItems: [
            {
              name: "New Listing",
